...
namespace PeteBrown
{
	namespace Devices
	{
		namespace Midi
		{
			public ref class MidiNrpnParameterNullMessage sealed
			...
			private:
				...
				const byte NRPN_PARAMETER_NUMBER_NULL = 127;


				// message order is ParameterNumberMsb, ParameterNumberLsb
				...
				{
					SetByte(PARAMETER_LSB_DATA2_BYTE_OFFSET, NRPN_PARAMETER_NUMBER_NULL);
					SetByte(PARAMETER_MSB_DATA2_BYTE_OFFSET, NRPN_PARAMETER_NUMBER_NULL);
				}
